...
mkdir ../build &&
cd ../build &&
#../qemu-9.2.4/configure –iasl=$DEPDIR/iasl/iasl.exe --enable-tcg --disable-tcg-interpreter --enable-hv-balloon --enable-fdt=auto --enable-qcow1 --disable-kvm --disable-hvf --enable-opengl --enable-slirp --target-list=x86_64-softmmu,i386-softmmu --enable-whpx --enable-sdl –audio-drv-list=sdl,pa --enable-relocatable --enable-strip --enable-membarrier --enable-iconv --enable-lto --enable-tools --prefix=$BUILDIR --extra-cflags="-Wno-deprecated-declarations -Wno-unused-function -D__USE_MINGW_ANSI_STDIO=1 -mtune=generic -march=x86-64-v2 " 2>&1 | tee ~/Configure-latest.txt  &&
